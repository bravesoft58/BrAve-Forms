...
1. **ISSUE-128:** Photo Gallery Grid View (4h) - CREATED
...
2. **ISSUE-129:** Photo Lightbox Viewer (3h) - CREATED
...
3. **ISSUE-130:** GPS Map Integration (4h) - CREATED
   - MapLibre GL JS integration (BSD license, FREE vs $5-20/mo Mapbox)
   - Free tile providers, clustering, offline support
   - Location: E:\BrAve Forms\docs\sprints\sprint5\issues\ISSUE-130.md

4. **ISSUE-131:** Photo Annotations (4h) - CREATED
   - Annotorious integration (BSD license, actively maintained)
   - Drawing tools, metadata tracking, annotation history
   - Location: E:\BrAve Forms\docs\sprints\sprint5\issues\ISSUE-131.md

5. **ISSUE-132:** Photo Search & Filter (3h) - CREATED
   - Advanced filtering (description, user, form type, date, GPS, weather)
   - Clear filters, backend query support
   - Location: E:\BrAve Forms\docs\sprints\sprint5\issues\ISSUE-132.md

6. **ISSUE-133:** Before/After Photo Pairing (2h) - CREATED
   - Side-by-side comparison, fade slider
   - Location: E:\BrAve Forms\docs\sprints\sprint5\issues\ISSUE-133.md

### Phase 2: Offline Experience UI (1 issue)

7. **ISSUE-134:** Sync Status Dashboard (4h) - CREATED
   - Current sync status, last/next sync timestamps
   - Sync statistics, storage usage meter
   - 30-day offline capability countdown
   - Location: E:\BrAve Forms\docs\sprints\sprint5\issues\ISSUE-134.md

### Phase 5: Form Builder (2 critical issues)

8. **ISSUE-150:** Form Builder Architecture Setup (6h) - CREATED
...
9. **ISSUE-155:** Calculated Fields Editor (10h) - CREATED
   ...
   - Location: E:\BrAve Forms\docs\sprints\sprint5\issues\ISSUE-155.md
...
**Step 1:** Read created issues (ISSUE-128 through ISSUE-155)
...
1. **ISSUE-151** (Field Palette) - Depends on ISSUE-150 (Architecture)
   - Implements 18 draggable field types
   - Uses @dnd-kit useDraggable hook
   - Search/filter palette fields

2. **ISSUE-152** (Form Canvas) - Depends on ISSUE-151 (Palette)
   - DndContext and SortableContext from @dnd-kit
   - Drag from palette, reorder within canvas
   - Visual drop indicators

3. **ISSUE-153** (Properties Panel) - Depends on ISSUE-152 (Canvas)
   - Field label, placeholder, help text
   - Validation rules
   - Default values

4. **ISSUE-154** (Conditional Logic) - Depends on ISSUE-153 (Properties)
   - "Show this field if..." builder
   - Operator selection (equals, contains, greater than)
   - AND/OR logic

5. **ISSUE-156** (Field Settings Tabs) - Depends on ISSUE-155 (Calculations)
...
├── ISSUE-128.md (Photo Gallery Grid View)
├── ISSUE-129.md (Photo Lightbox Viewer)
├── ISSUE-130.md (GPS Map Integration)
├── ISSUE-131.md (Photo Annotations)
├── ISSUE-132.md (Photo Search & Filter)
├── ISSUE-133.md (Before/After Photo Pairing)
├── ISSUE-134.md (Sync Status Dashboard)
├── ISSUE-150.md (Form Builder Architecture Setup)
└── ISSUE-155.md (Calculated Fields Editor)
```
...
- Form Builder foundation: YES (ISSUE-150)
- Photo Gallery core: YES (ISSUE-128, ISSUE-129, ISSUE-130)
- Calculated fields: YES (ISSUE-155)
