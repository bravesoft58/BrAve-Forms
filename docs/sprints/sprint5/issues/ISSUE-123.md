...
**Screenshot:** Save to `evidence/ISSUE-123/test-results/red-phase.png`
...
**Screenshot:** Save to `evidence/ISSUE-123/test-results/green-phase.png`
...
- Prerequisites: ISSUE-123 complete (grid view ready)
