# ISSUE-130: GPS Map Integration (4h)
...
- [ ] ISSUE-160 complete (Photo lightbox functional)
...
**Screenshot:** Save to `evidence/ISSUE-161/test-results/red-phase.png`
...
**Screenshot:** Save to `evidence/ISSUE-161/test-results/green-phase.png`
...
**ISSUE-131:** [Next issue title]

- Prerequisites: ISSUE-130 complete (map view ready)
