...
function makeEmptyData(projectName: string, contractNumber: string, location: string): NdotStormwaterData {
  ...
  return {
    ...
    illicit_discharges_desc: "",
    reportable_spills: undefined,
    reportable_spills_desc: "",
    spill_action: undefined,
    ndep_report_filed: undefined,
    non_reportable_spills: undefined,
    non_reportable_spills_desc: "",
    non_structural_bmps: undefined,
    non_structural_bmps_desc: "",
    all_areas_inspected: undefined,
    all_areas_inspected_explain: "",
    additional_comments: "",
    photos: [],
    inspector_name: "",
